...
def main():
    ...
    pretrain_model = 'thorirhrafn/sft_gpt1b_domar_pretuned'
    pretuned_model = PeftModel.from_pretrained(original_model, pretrain_model)
    pretuned_model = pretuned_model.merge_and_unload()

    # load fine-tuned adapter and merge into model for training and as reference
    peft_model = 'thorirhrafn/gpt1B_domar_finetune'
    ...
    output_dir = 'thorirhrafn/gpt1B_DPO_model'
