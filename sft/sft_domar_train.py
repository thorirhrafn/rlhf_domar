...
def get_summaries(dataset, model, tokenizer, start=0,end=10, device='cpu', print_output=False):
    ...
    for _, dialogue in enumerate(dialogues):
        ...
        model_outputs = model.generate(input_ids=input_ids, generation_config=GenerationConfig(max_new_tokens=250))
...
def main():
    ...
    peft_model = 'thorirhrafn/gpt7b_domar_pretuned'
    model = PeftModel.from_pretrained(original_model, peft_model, is_trainable=True)
    ...
    output_dir = 'thorirhrafn/gpt7B_domar_finetune'
